...
export default function Navbar() {
  return (
    ...
    >
      ...
      <nav className="hidden md:flex items-center gap-12 text-sm font-medium text-slate-400">
        <a href="#timeline" className="hover:text-brand-emerald transition-colors">Roadmap</a>
      ...
      <div className="flex items-center gap-4">
        <a 
          href="#connect"
          className="px-4 py-1.5 rounded-lg bg-brand-emerald hover:bg-brand-emerald/90 text-bg-deep text-xs font-bold transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)]"
        >
          Get Started
        </a>
      </div>
