  ...
  return (
    <section id="mvp" className="relative py-20 px-6 lg:px-12 w-full max-w-7xl mx-auto z-10">
      ...
      <div className="mb-12 text-center lg:text-left">
        <div className="flex flex-col sm:flex-row items-center lg:items-start gap-3 sm:gap-6 mb-3 justify-center lg:justify-start">
          ...
          <a
            href="https://opti-mvp.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs font-semibold text-slate-400 hover:text-brand-emerald transition-colors inline-flex items-center gap-1.5 py-1"
          >
            Click here to access MVP
          ...
          >
            <div className="flex items-center justify-between border-b border-white/5 pb-3">
              <div className="flex items-center gap-2">
                <div className="bg-brand-emerald/10 rounded-full p-1.5 border border-brand-emerald/20 text-brand-emerald shadow-[0_0_10px_rgba(124,229,186,0.2)]">
            ...
            <button className="w-full bg-brand-emerald hover:bg-brand-emerald/90 text-bg-deep rounded-xl py-2.5 flex items-center justify-center gap-1.5 font-bold text-xs shadow-[0_0_20px_rgba(124,229,186,0.3)] group-hover:shadow-[0_0_25px_rgba(124,229,186,0.5)] transition-all">
