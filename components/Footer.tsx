        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 text-sm text-slate-400">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="px-3.5 py-1.5 rounded-lg border border-white/5 bg-white/5 hover:border-brand-emerald/30 hover:bg-brand-emerald/5 transition-all text-xs font-medium text-white flex items-center gap-1.5 shadow-md hover:shadow-[0_0_15px_rgba(16,185,129,0.1)]"
            >
